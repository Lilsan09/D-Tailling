...
<form class="container-fluid d-flex connexionForm justify-content-center align-items-center py-3" method="POST">
   <fieldset class="d-flex flex-column align-items-center h-auto glassForm row">
      ...
      <div class="form-group col-12 my-4">
         ...
         <input name="lastname" type="text" class="form-control" id="lastname" placeholder="Michel">
      </div>
      <div class="form-group col-12 my-4">
         <label for="firstname" class="form-label ms-2">Prénom</label>
         <input name="firstname" type="text" class="form-control" id="firstname" placeholder="Dubois">
      </div>
      <div class="form-group col-12 mt-3">
         <label for="message" class="form-label ms-2">Votre message</label>
         <textarea name="message" class="form-control" id="message" rows="3"></textarea>
      </div>
      <button type="submit" class="btn btn-primary mt-5 col-6 col-lg-2">Envoyer</button>
   </fieldset>
</form>