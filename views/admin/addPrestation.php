   ...
   <fieldset class="row justify-content-center glassForm my-4 flex-column align-items-center">
      ...
      <div class="col-lg-6">
         <div class="form-group">
            ...
            <input value="<?= $title ?? '' ?>" name="title" type="text" class="form-control" id="mail" aria-describedby="titleHelp" required>
            <p><?= $errors['title'] ?? ''; ?></p>
         </div>
         <div class="form-group">
      ...
      <button type="submit" class="btn btn-primary btn-sm col-lg-3">Ajouter la prestation</button>
   </fieldset>
</form>