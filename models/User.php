...
class User
{
   ...
   public function add(int $id = null)
   {
      ...
      $sth = $this->pdo->prepare('INSERT INTO `users` (`lastname`, `firstname`, `email`, `password`, `adress`, `zipcode`, `phone`) VALUES (:lastname, :firstname, :email, :password, :adress, :zipcode, :phone)');
   ...
   // Methode pour lister tout les utilisateurs sans barre de recherche
